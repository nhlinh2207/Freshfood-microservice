package com.linh.UserService.config.keycloak;
...
//        Print username and client in a current realm
...
//        keycloakCurrentUser.setStatus(response.getStatusInfo().toString());
        ...
        if (response.getStatus() == 201) {
            ...
            RoleRepresentation realmRole = realmResource.roles().get("REALM_USER").toRepresentation();
